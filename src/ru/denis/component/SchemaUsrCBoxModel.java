 ...
 * @author naumenko_ds
 */
public class SchemaUsrCBoxModel extends DefaultComboBoxModel{
    ...
    public void setDataSource(){
        ...
        try {
            ...
            List<SchemaUsrObject> listelement = dbu.getListSchemaUsrObject();
        
            for(SchemaUsrObject itemi : listelement){
                addElement(itemi);
            }           
